...
description: 'Quick Setup - Playwright with Synpress'
---
...
Synpress provides many advanced features for Web3 testing:
...
Check out the [API documentation](/api-reference/) for detailed information about these features.
