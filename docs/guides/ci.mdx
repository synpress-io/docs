...
<Warning>
The `xvfb-run` is required here in both steps because Synpress and Playwright must run in the headful mode on CI. See the [Known Issues](../known-issues) section for an explanation of why this is the case.
</Warning>
