...
*   Due to limitations with MetaMask, running tests in headless mode on CI (especially GitHub Actions) requires special configuration.  You'll likely need to use a virtual display like `xvfb-run`.
