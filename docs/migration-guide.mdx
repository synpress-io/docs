---
title: Migration Guide - Synpress v3 to v4 (Cypress)
---

# Migrating from Synpress v3 to v4 (Cypress)
...
*   **File Content:** Use the `defineWalletSetup` function to define the setup steps.
    ...
    import { MetaMask, defineWalletSetup, getExtensionId } from '@synthetixio/synpress/playwright';
