...
<Warning>
This migration guide is particularly for Cypress users. If you're using Playwright with Synpress, please refer to the [Playwright-specific documentation](./setup-playwright).
</Warning>
